<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="ProductStandard" v-model="item.productStandard" :editMode="editMode" @change="change" />
            </div>
            ...
            <ProductDetailManager offline label="ProductDetail" v-model="item.productDetail" :editMode="false" @change="change" />
        </v-card-text>
