<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="ProductStandard" v-model="value.productStandard" :editMode="editMode"/>
            ...
            <ProductDetailManager offline label="ProductDetail" v-model="value.productDetail" :editMode="editMode" @change="change"/>
        </v-card-text>
