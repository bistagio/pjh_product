<template>
    <div style="max-height:80vh;">
        ...
        <ProductViewQuery @search="search"></ProductViewQuery>
        ...
        >
            <wj-flex-grid-filter :filterColumns="['productNo','productName','productStandard','materialId','processId','productDetail',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="productDetail[0].name" header="productDetail" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="productNo" header="productNo" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="productName" header="productName" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="productStandard" header="productStandard" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="materialId.name" header="material" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="processId.name" header="process" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <ProductDetailDetailGrid :selectedGrid="selectedGrid" />
...
<script>
import ProductViewQuery from '../components/ProductViewQuery.vue';
import Product from '../components/Product.vue'
import ProductDetailDetailGrid from './ProductDetailDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.productDetail;
